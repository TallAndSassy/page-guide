...
namespace TallAndSassy\PageGuide\Tests;

use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Facades\Route;
use Orchestra\Testbench\TestCase as Orchestra;
use TallAndSassy\PageGuide\PageGuideServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    public function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'TallAndSassy\\PageGuide\\Database\\Factories\\'.class_basename($modelName).'Factory'
        );

        // route prefix
        // this must match/sync with what was put in
        // tests/Feature/Http/Controllers/PageGuideControllerTest.php/setup
    ...
    {
        return [
            PageGuideServiceProvider::class,
        ];
    }
    ...
    public function getEnvironmentSetUp($app)
    {
        ...
        include_once __DIR__.'/../database/migrations/create_page_guide_table.php';
        (new \CreatePageGuideTable())->up();
    }
}
