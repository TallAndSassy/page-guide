@php
    ...
    // JJ - How can you make these common without perculating up the heirarchy?  Simple includes hide varaibles.
             ...
             $divNode_cssClasses     = "$linkFontColor_cssClasses        $linkFocus_cssClasses no-underline group flex items-center px-2 py-0 text-md leading-5 font-bold   ";

             $firstLeaf_cssClasses   = "$linkFontColor_cssClasses        $linkFocus_cssClasses px-2 text-lg leading-5 font-bold    ";
             $secondLeaf_cssClasses  = "$linkFontColor_cssClasses        $linkFocus_cssClasses group flex items-center px-2 pb-2 text-sm leading-5 rounded-md  ";
